            ...
            <div class="brand-panel">
                <div class="brand-mark">
                    <span class="brand-logo" aria-hidden="true">
                        <img src="<?php echo e(file_exists(public_path('dist/asset/image/logo/logo.png')) ? asset('dist/asset/image/logo/logo.png') : asset('admin/dist/assets/images/logo/logo.png')); ?>"
                            alt="eBook Logo">
                    </span>
                    <span>eBook</span>
                </div>
